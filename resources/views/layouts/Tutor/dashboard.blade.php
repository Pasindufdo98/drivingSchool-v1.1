...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <a class="navbar-brand fw-bold ms-auto" href="#" id="topic"><span class="px-2"><img src="logo.svg" width="30" height="30" alt=""></span>RUWANSIRI DRIVING SCHOOL</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex ms-auto">
              ...
              <li><span><a href="tutornotice"><i class="bi bi-bell p-3">Notice</i></a></span></li>
      ...
      <div class="offcanvas offcanvas-start sidebar-nav bg-dark text-white fw-bold" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <nav class="navbar-dark">
          ...
          <ul class="navbar-nav">
            ...
            <li>
             <a href="/selectDate" class="nav-link px-3">
              <span class="me-2">
                  ...
                  <ul class="navbar-nav ps-3">
                    ...
                    <li>
                      <a href="{{ route('quiz') }}" class="nav-link me-2 px-3">
                        <span class="px-2"><i class="bi bi-user"></i> </i></span><span>Quiz</span></a>
                    </li>
            ...
            <li>
              <a href="{{ route('selectDate') }}" class="nav-link px-3 py-3">
               <span class="me-2">
